...
def get_ru_check_from_filename(filename: str) -> str | None:
    """Extract the RU check characters from a filename.
    ...
    """
    # Filename like 90826421137T_202112_266_20220920110706.xlsx
    # Check letter return T
    pattern = r'^[0-9]{11}([A-Z0-9]{1})_[0-9]{6}_[0-9]{3}_.*\.xlsx'
